...
=======
    ...
    this.userRepository.save(
            new User(
                    "Sue", "Martin", "smartin", "email2@email.com", "password", 87654321, 453,
                    11052024));
    //Create some movies.
    Movie movie1 = new Movie("The Cake Knight Rises", "A cake knight will rise.", LocalDate.now(), LocalDate.now());
    Movie movie2 = new Movie("Love, Probably", "A film about love, probably", LocalDate.now(), LocalDate.now());
...
//    this.showtimeRepository.save(showtime1);
//    this.showtimeRepository.save(showtime2);
>>>>>>> 2ec179ffd26a1a2e2f4564098caa10a8e75fd1e7
  }
}