...
public class SeatService {
  ...
  public SeatService(
      SeatRepository seatrepository, ShowtimeService showtimeService, TicketService ticketService) {
  ...
  public void ReserveSeat(Seat seat) {
    ...
    if (reserveSeat.isPresent()) reserveSeat.get().setReserved(true);
    else {
  ...
  public void CancelSeat(Seat seat) {
    ...
    if (cancelSeat.isPresent()) cancelSeat.get().setReserved(false);
    else {
      throw new IllegalStateException("Seat not found");
    }
  }
